...
export const metadata: Metadata = { title: "Sign In | WinkGetJob" };

const features = [
  "Access thousands of top freelance jobs in India",
  "Milestone payments secured via escrow safety",
  "Real-time communication & contract management",
  "Zero platform fee for independent developers",
];
...
export default function SignInPage() {
  return (
    <div className="h-screen flex flex-col lg:flex-row bg-[#f8fafc] overflow-hidden" style={{ fontFamily: "var(--font-poppins), sans-serif" }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#0f172a] flex-col justify-between p-6 sm:p-8 lg:p-10 text-white overflow-hidden lg:h-full">
        ...
        <div className="relative z-10 my-auto py-4 lg:py-0 max-w-xl">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white mb-3 leading-tight">
            Connecting India's Elite Talent.
          </h1>
          <p className="text-gray-300 text-xs sm:text-sm mb-5 leading-relaxed">
            Access secure milestone contracts, build your professional portfolio, and collaborate directly with certified employers.
          </p>
          ...
          <ul className="space-y-2 mb-5">
            {features.map((f) => (
              <li key={f} className="flex items-start gap-2">
                ...
                <span className="text-xs sm:text-sm text-gray-250 font-medium">{f}</span>
              </li>
            ))}
          </ul>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-3.5 shadow-lg relative">
            ...
            <p className="text-[11px] text-gray-250 italic leading-relaxed mb-2.5">
              "WinkGetJob simplified contracts and secure billing. I was matching with a high-paying engineering team in Bangalore within 3 days."
            </p>
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-full bg-gradient-to-tr from-[#d4a017] to-[#1e3a5f] flex items-center justify-center font-bold text-[9px]">
                AR
              </div>
              <div>
                <h4 className="text-[11px] font-semibold text-white">Aniket Roy</h4>
                <p className="text-[8px] text-gray-400">Full-Stack Engineer, Bangalore</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Right panel: Centered Login Form (50% Width on Desktop, 100% on Mobile) */}
          ...
          <div className="w-full max-w-md bg-white rounded-2xl border border-gray-100 p-5 sm:p-7 shadow-md relative overflow-hidden">
            ...
            <div className="mb-4">
              ...
              <p className="text-[11px] text-gray-555 mt-0.5">
                Access your secure workspace to manage projects, proposals, and invoices.
              </p>
            </div>
