    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 flex-shrink-0">
          <span className="text-sm font-semibold text-gray-700">Application Details</span>
          <button
            onClick={onClose}
        ...
        {/* Scrollable body */}
        <div className={cn("flex-1 overflow-y-auto p-6 space-y-6", showActions ? "pb-24" : "")}>
          {/* Applicant hero */}
          <div className="flex items-start gap-4 pb-4 border-b border-gray-100">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex flex-wrap items-center gap-2 mb-1">
                ...
                <IdBadge id={application._id} prefix="APP" />
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-6 py-4 flex flex-wrap gap-2">
            {application.status === "pending" && (
              <Button
                size="sm"
                variant="secondary"
                className="text-purple-700 bg-purple-50 hover:bg-purple-100 border border-purple-200 flex-1 sm:flex-none"
