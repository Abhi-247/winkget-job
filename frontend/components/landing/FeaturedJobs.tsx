    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative">
          ...
          <div 
            ref={scrollRef}
            className="flex items-stretch gap-4 sm:gap-6 overflow-x-auto py-2 pb-4 scrollbar-hide snap-x snap-mandatory scroll-smooth px-2 -mx-2"
          >
          {loading
            ? Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="bg-white rounded-3xl border border-slate-100 p-6 animate-pulse space-y-4 w-[76%] sm:w-[calc(50%-12px)] lg:w-[calc(25%-18px)] flex-shrink-0 snap-start flex flex-col justify-between">
            ...
            : filteredJobs.map((job) => (
                <div
                  key={job._id}
                  className="w-[76%] sm:w-[calc(50%-12px)] lg:w-[calc(25%-18px)] flex-shrink-0 snap-start flex flex-col"
                >
                  <FeaturedJobCard
                    job={job}
